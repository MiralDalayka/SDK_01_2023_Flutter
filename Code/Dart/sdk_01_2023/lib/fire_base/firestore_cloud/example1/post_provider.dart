...
import 'package:sdk_flutter_07_2022/firestore_cloud/example1/post_prefs.dart';
import 'package:sdk_flutter_07_2022/firestore_cloud/example1/post_service.dart';
...
class PostProvider extends ChangeNotifier {
  ...
  PostList get offlinePosts {
    ...
    //get --> null
    var data = Prefs.getListStringValue('postsDataFireCloud') ?? [];
    if (data.isNotEmpty) {
  ...
  void refreshPrefs() async {
    await Prefs.removeValue('postsDataFireCloud');
    PostModel model;
    String encodeData = '';
    List<String> posts = [];
    ...
    Prefs.setStringListValue('postsDataFireCloud', posts);
  }
}
