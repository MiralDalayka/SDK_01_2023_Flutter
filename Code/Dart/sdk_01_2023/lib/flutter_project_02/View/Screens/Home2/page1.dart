...
import 'package:miral_flutter_01_2023/flutter_project_01/View/Screens/Home2/page2.dart';


class Page__1 extends StatefulWidget {
  const Page__1({Key? key}) : super(key: key);

  @override
  State<Page__1> createState() => _Page__1State();
}

class _Page__1State extends State<Page__1> {
  @override
    ...
    return Padding(
      ...
      child: Scaffold(
                  ...
                  children: [
                    InkWell(
                      ...
                      child: SizedBox(
                        width: 80,
                        height: 50,
                        child: Image.network('https://cdn.shopify.com/s/files/1/0627/5517/products/ChronoS40mmSilver_Tan_540x.jpg?v=1686697214'),),
                    ),
        ...
        persistentFooterButtons: [
          ...
          TextButton(
            child: const Text('Explore',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.black),),
            onPressed: () => {},),
